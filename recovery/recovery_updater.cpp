...
void Register_librecovery_updater_exynos2100() {
  RegisterFunction("exynos2100.verify_no_downgrade", VerifyNoDowngradeFn);
  RegisterFunction("exynos2100.mark_header_bt", MarkHeaderBtFn);
  RegisterFunction("exynos2100.write_data_bt", WriteDataBtFn);
}
